...
import { mockTransactions } from 'common/data/mockData';
import DownloadOutlinedIcon from '@mui/icons-material/DownloadingOutlined';
...
import StatBox from 'common/components/stat-box/StatBox';
